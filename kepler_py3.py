...
def orbit_solution(t_or_E, e, P, t0, w, i, o, m_p, m_star, d_star, units = 'arcsec', solve_kepler = True):
    """
    :param t_or_E:
    :type t_or_E: ndarray
    :param e: orbital eccentricity
...
def angular_sep(t, e, P, t0, w, i, m_p, m_star, d_star):
    """
...
def fit_rv_ast_orbit(t, e, P, t0, w, i, o, m_p, m_star=0.781, d_star=3.216):

    # assume first 2 data points/times are for the astrometric data and all the rest are RV data

    x, y, _ = orbit_solution(t[0], e, P, t0, w, i, o, m_p, m_star, d_star, units='arcsec')

    _, _, rv = orbit_solution(t[2:], e, P, t0, w, i, o, m_p, m_star, d_star, units='arcsec')

    return np.concatenate(([x],[y],rv))
